...
#define ALTVOLT_MOSFET_1_Pin GPIO_PIN_1
#define ALTVOLT_MOSFET_1_GPIO_Port GPIOB
#define ALTVOLT_MOSFET_2_Pin GPIO_PIN_10
#define ALTVOLT_MOSFET_2_GPIO_Port GPIOB
